...
<div id="viewer">
    <div id="header">
        <div class="left">
            ...
            <div class="date">25th Feb 2024</div>
        </div>
        <div class="right">
        ...
        <div class="personal-detail-box">
            <div class="personal-detail-inner-box1">
                <div class="personal-detail-sub-box">
                    ...
                    <div class="personal-details-data">HOBC IMPORT EXPORT PRIVATE LIMITED</div>
                </div>
                <div class="personal-detail-sub-box">
                    <div class="personal-detail-logo-name">
                        <span>
                ...
                <div class="personal-detail-sub-box">
                    ...
                    <div class="personal-details-data">29AAGCH3941L1Z6</div>
                </div>
                <div class="personal-detail-sub-box">
                    <div class="personal-detail-logo-name">
                        <span>
