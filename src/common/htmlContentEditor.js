export const htmlContentEditor = (item, qr) => {
  ...
  const cgstAndSgstTable = `
    ...
    <thead>
        ...
        <th class="font-medium">CGST</th>
        <th class="font-medium">SGST</th>
        <th class="font-medium">Total Tax Amount</th>
    </thead>
    <tbody>
        <tr>
            <td></td>
            <td >₹${(grosTotal - (cgst + sgst)).toFixed(2)}</td>
            <td>
        ...
        <tr>
            <td></td>
            <td >Total</td>
            <td><span class="color-blue">₹${item.CGST}</span></td>
            <td><span class="color-blue">₹${item.SGST}</span></td>
