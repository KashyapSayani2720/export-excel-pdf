  ...
  return (
    <div className='calendar-container'>
        <div className='calendar-header'>
            <div><button className='calendar-buttons'><img src={CalendarHeaderLeft} alt="left" width={10} height={8}/></button><span className='months-heading'>{previousMonth}</span></div>
            <div className='calender-month-box'>
                {month} {year} <MonthPicker format={monthFormat} inputReadOnly={true} onChange={yearChangeHandler} className="calender-month-picker"/>
            </div>
            <div><span className='months-heading'>{nextMonth}</span><button className='calendar-buttons'><img src={CalendarHeaderRight} alt="right"  width={10} height={8}/></button></div>
        </div>
        ...
        {days?.map((item)=>{
            ...
            <div className='day-card'>
                <div className='day-card-day'>{item?.dayName.substring(0, 3)}</div>
